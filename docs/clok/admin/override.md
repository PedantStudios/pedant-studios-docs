...
sidebar_position: 7
title: Override
description: Manager workflow for correcting time clock and mileage entries in Pedant Clok, including the Force Clock Out action for forgotten clock-outs.
---
