...
- An expiration date — invitations are typically valid for 7 days

If you don't see the email, check your spam, junk, and promotions folders. If it's truly missing, ask the admin who invited you to **resend** it (they can do this from their **Admin → Employees → Invitations** screen).
...
- Pick something stable — usernames don't change later

## Password rules

- Minimum 12 characters
- No other complexity rules; use a passphrase if it's easier
- See **[Forgot password](./forgot-password)** if you ever need to reset

## Token expired or already used

Invitation links are time-limited and single-use. If yours has expired or been used:

- **Expired** — Ask the admin to **resend** the invitation. They'll see your name on the Invitations tab with a "Resend" button.
- **Already used** — You're already in. Go to the login page and sign in with the username/password you set.
- **Revoked** — If the admin revoked the invite (you'd see an explicit error page), they'll need to send a fresh one.
